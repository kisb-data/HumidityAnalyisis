...
with colB:
    ...
    st.markdown('''Here we can see our 3 main parameters, temperature, absolute and relative humidity. I measured data on four sides of the house at 30 cm from the base and one place under the slab and for comparison one place outside. The data was collected manually at random times.''')
